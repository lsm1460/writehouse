...
import { GameMenuLayout, type MenuItem } from './GameMenuLayout'
...
export const ConfigMenu: React.FC<ConfigMenuProps> = ({ back }) => {
  ...
  return <GameMenuLayout key={currentMenu} engine={engine} menuItems={menuConfig[currentMenu]} />
}
