...
export function RoomTransition({ roomId, onTransitionEnd }: RoomTransitionProps) {
  const { t } = useTranslation()

  const floorNumber = roomId.split('-')[0] || '1'

  return (
    <FadeOverlay mode="fadeInOut" delayMS={500} durationMS={1000} midDelayMS={1200} onAnimationEnd={onTransitionEnd}>
